...
unset($__errorArgs, $__bag); ?>" 
                                ...
                                <option value="Manajemen Informatika" <?php echo e(old('jurusan', $dosen->jurusan) == 'Manajemen Informatika' ? 'selected' : ''); ?>>Manajemen Informatika</option>
                            </select>
...
unset($__errorArgs, $__bag); ?>" 
                                      rows="3" 
                                      placeholder="Masukkan alamat lengkap"><?php echo e(old('alamat', $dosen->alamat)); ?></textarea>
...
unset($__errorArgs, $__bag); ?>" 
                                   value="<?php echo e(old('no_telp', $dosen->no_telp)); ?>" 
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="form-group">
                            ...
                            <a href="<?php echo e(route('dosen.index')); ?>" class="btn btn-secondary">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laravel\mahasiswa-uym\resources\views/dosen/edit.blade.php ENDPATH**/ ?>